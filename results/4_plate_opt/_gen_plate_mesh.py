...
parser.add_argument("--nxe", type=int, default=64, help="# elements along length (and each direc)")
...
with open(output_file, "w") as fout:
    ...
    for node in y_bcnodes:
        write_bulk_line("SPC", [1, node, "1235", 0.0])
