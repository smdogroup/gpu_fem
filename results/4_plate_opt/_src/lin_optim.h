...
class LinearPlateSolver {
   public:
    ...
    LinearPlateSolver(double rhoKS = 100.0, double safety_factor = 1.5,
        ...
        mg->init_outer_solver(cublasHandle, cusparseHandle, nsmooth, ninnercyc, n_krylov, omega, atol, rtol, print_freq, print, double_smooth);    
