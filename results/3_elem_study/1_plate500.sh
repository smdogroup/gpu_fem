...
mpiexec -n 1 ./0_plate.out --SR 500 --elem MITC9 --nxe 256 --nsmooth 8 --omega 0.
...
mpiexec -n 1 ./0_plate.out --SR 500 --elem AIG9 --nxe 128 --nsmooth 1
mpiexec -n 1 ./0_plate.out --SR 500 --elem AIG9 --nxe 256 --nsmooth 1
