...
# mpiexec -n 1 ./0_plate.out --SR 10.0 --elem CFI4 --nxe 2048 --nsmooth 2
# mpiexec -n 1 ./0_plate.out --SR 10.0 --elem MITC4 --nxe 2048 --nsmooth 2
# mpiexec -n 1 ./0_plate.out --SR 10.0 --elem CFI9 --nxe 512 --nsmooth 2
# mpiexec -n 1 ./0_plate.out --SR 10.0 --elem MITC9 --nxe 512 --nsmooth 2 --nsmooth 16 --omega 0.95
# mpiexec -n 1 ./0_plate.out --SR 10.0 --elem CFI16 --nxe 256 --nsmooth 4
# mpiexec -n 1 ./0_plate.out --SR 10.0 --elem MITC16 --nxe 256 --nsmooth 4
# mpiexec -n 1 ./0_plate.out --SR 10.0 --elem LFI16 --nxe 256 --nsmooth 4
# mpiexec -n 1 ./0_plate.out direct --SR 10.0 --elem HRA4 --nxe 256
# mpiexec -n 1 ./0_plate.out direct --SR 10.0 --elem HRA4 --nxe 512