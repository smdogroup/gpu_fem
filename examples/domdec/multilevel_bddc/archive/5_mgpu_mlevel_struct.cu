// multilevel structured BDDC with cylinder using multi GPU code
...
int main(int argc, char **argv) {
    ...
    // build coarser splitting
    // assume same subdomain size but doubled gives you the coarse num elements
    int nxs2 = nxs / nxe_subdomain_size;
    printf("coarse splitting\n");
    auto coarse_spit = split->setup_coarse_structured_subdomains(nxs2, nxs2);
    printf("\tdone with coarse splitting\n");
