...
make 3_scyl_unstruct
echo "run 3_scyl_unstruct.out"
./3_scyl_unstruct.out --nxe ${NX} --subdomain ${SD} >> out3.txt

make 4_mcyl_unstruct
echo "run 4_mcyl_unstruct.out"
./4_mcyl_unstruct.out >> out4.txt