...
# =============================================================================
# 2D Assembler: structured grid, block-CSR, mixed DRIG sphere (open hoop)
# Updated spaces:
#   w   ~ (p2,p2)  "2x2 IGA"
#   thx ~ (p1,p2)  "1x2 IGA"
#   thy ~ (p2,p1)  "2x1 IGA"
...
#   U = [ w, u, v, thx, thy ]
# =============================================================================
class DeRhamIGASphereAssembler:
    """
    Structured 2D IGA sphere discretization on (x,s) for the mixed element:
