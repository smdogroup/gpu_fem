...
def vcycle_solve(grids:list, nvcycles:int=100, pre_smooth:int=1, post_smooth:int=1, 
    ...
    mats = [grids[i].kmat.tocsr().copy() for i in range(nlevels)]
