...
class ShellIsotropicDataV3 {
   public:
    ...
    __HOST_DEVICE__ ShellIsotropicDataV3(T E_, T nu_, T thick_, T refAxis_[], T ys_ = 1.0,
    ...
    template <bool U = has_ref_axis, typename std::enable_if<!U, int>::type = 0>
    __HOST_DEVICE__ ShellIsotropicDataV3(T E_, T nu_, T thick_, T ys_ = 1.0, T rho_ = 1.0,
                                         T tOffset_ = 0.0)
        : E(E_), nu(nu_), thick(thick_), ys(ys_), rho(rho_), tOffset(tOffset_) {}
